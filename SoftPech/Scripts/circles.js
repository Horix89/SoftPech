...
/*
  ...
  Call Circles.create(options) with the following options:
    ...
    textPorcentaje - % de hacemos
    textWeDo       - the text to display at the centre of the graph (optional, the current "htmlified" value will be shown if not specified)
...
(function () {
    ...
    Circles = window.Circles = function (options) {
        ...
        this._text = this._centrarText(options.value);//options.value + '%';
        //alert(this._text);
    ...
    Circles.prototype = {
        ...
        _generateWrapper: function () {
            ...
            //this._wrapContainer.innerHTML = this._wrapContainer.innerHTML + "<div style='text-align: center;'>programcion web</div>";
        ...
        _centrarText: function (porcentaje) {
